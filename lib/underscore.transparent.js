  ...
  var
    ...
    defaultObjectProperties = {
      'Collection': [// Array or Object functions
        ...
        'every', 'some', 'contains', 'invoke', 'pluck', 'max', 'min', 'sortBy', 'groupBy', 'indexBy', 'countBy', 'shuffle', 'sample',
        'toArray', 'size',
        // Alias functions
      ...
      'String': [
        ...
        'toBoolean', 'surround', 'quote', 'unquote', 'slugify', //, 'include', 'reverse'
    ...
    defineHash = function(scope) {
      // Hash definition
        scope.Hash = function (obj) {
          merge(this, obj);
        };

        scope.Hash.prototype.constructor = object;

      defineProperty(object, 'toHash', function(obj) {
        if (obj === null && scope != this && object != this) {
          obj = this;
        }

        return (_.isObject(obj)) ? new scope.Hash(obj) : obj;
      });
      scope.toHash = object.toHash;

      defineProperty(object, 'toObject', function(obj) {
        if (obj === null && scope != this && object != this) {
          obj = this;
        }
        return (_.isObject(obj) && obj instanceof scope.Hash) ? merge({}, obj) : obj;
      });
      scope.toObject = object.toObject;
    },
      ...
      transparent: function (options) {
        ...
        for(target in objects) {
          if (hasOwnProperty(objects, target)) {
            ...
            defineProperties(target, properties, scope);
          }
        }
      }
    };
